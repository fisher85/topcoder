...
eg = eGreedy(env=en1, n_learning=20, e=0.1)
en1.run(agent=eg)
...
for i in range(n_tests):
    en0 = Environment(machines, payouts, 1000)
    rs = RandomSampler(env=en0)
    rs_scoress[i] = en0.run(agent=rs)
    
    en1 = Environment(machines, payouts, 1000)
    eg = eGreedy(env=en1, n_learning=20, e=0.1)
...
plt.savefig("2019-05-21 Yandex ML 2019/Task B/bandit_algorithms/simualtion_100.jpg")
...
plt.savefig("2019-05-21 Yandex ML 2019/Task B/bandit_algorithms/rs_samples.jpg")


# In[788]:


plot_k_choices(eg, en1, "e-greedy")
plt.title("e-greedy - variant selections")
plt.xlabel("Trial")
plt.ylabel("Variant")
plt.savefig("2019-05-21 Yandex ML 2019/Task B/bandit_algorithms/eg_samples.jpg");


# In[789]:


plot_k_choices(tsa, en2, "Thompson Sampler")
plt.title("Thompson Sampler - variant selections")
plt.xlabel("Trial")
plt.ylabel("Variant")
plt.savefig("2019-05-21 Yandex ML 2019/Task B/bandit_algorithms/ts_samples.jpg");
...
plt.savefig("2019-05-21 Yandex ML 2019/Task B/bandit_algorithms/regret.jpg")
...
plt.savefig("2019-05-21 Yandex ML 2019/Task B/bandit_algorithms/posteriors.jpg")
